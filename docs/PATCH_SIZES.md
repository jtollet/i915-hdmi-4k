...
| Size (bytes) | Path |
|---:|---|
| 401 | `patches/local-archives/i915-fix-linear-tiling.patch` |
| 795 | `patches/local-archives/fix_4k_format.patch` |
...
| 1442 | `patches/local-archives/0003-drm-i915-skl-Fix-LINEAR-tiling-initialization.patch` |
| 1744 | `patches/local-archives/0000-cover-letter.patch` |
| 1855 | `patches/remote/test1_delay_before_buf_enable.patch` |
| 1864 | `patches/remote/test2_delay_before_power_up_lanes.patch` |
| 1865 | `patches/local-archives/0001-drm-i915-fix-4k60hz-hdmi.patch` |
...
| 2129 | `patches/local-archives/0002-drm-i915-hdmi-Apply-VC-Payload-workaround-for-HDMI.patch` |
...
| 2597 | `patches/local-patches-dir/0001-drm-i915-hdmi-Fix-4K-60Hz-HDMI-display-with-SCDC-timing.patch` |
| 2623 | `patches/local-archives/combined_4k_fix.patch` |
...
| 3846 | `patches/remote-linux/0001-drm-i915-hdmi-Poll-for-200-msec-for-TMDS_Scrambler_S.patch` |
